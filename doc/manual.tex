...
The memory map of the system is mostly organized into 512MB sections, using the
\texttt{A31}, \texttt{A30}, and \texttt{A29} signals to select them.
The system boot ROM is mapped at \mbox{\texttt{\$00000000-\$1FFFFFFF}}, followed
by DRAM and SRAM areas.
...
\begin{figure}[]
	...
	\vspace{2ex}
	\begin{bytefield}{12}
		\memsection{0000 0000}{}{4}{ROM Area}\\
		\memsection{2000 0000}{}{4}{DRAM Area}\\
		\memsection{4000 0000}{}{4}{SRAM Area}\\
		\memsection{6000 0000}{}{4}{-}\\
		\memsection{}{}{4}{-}\\
		\memsection{}{}{4}{-}\\
		\memsection{}{}{4}{-}\\
		\memsection{E000 0000}{FFFF FFFF}{4}{Expansion Card Area}\\
